...
class Ui_MainWindowBase(object):
    def setupUi(self, MainWindowBase):
        ...
        self.config_File_name_readOnly.setGeometry(QtCore.QRect(150, 50, 381, 20))
